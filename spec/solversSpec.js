describe('solvers', function() {
  ...
  describe('countNQueensSolutionsAsync()', function() {

    it('finds the number of valid solutions for n of 0-8', function() {
      _.range(0, 9).map(function(n) {
        var solutionCount = countNQueensSolutionsAsync(n);
        var expectedSolutionCount = [1, 1, 0, 0, 2, 10, 4, 40, 92][n];
  ...
  // Attempt to construct an async Mocha test
  // describe('countNQueensSolutionsAsync()', async function(done) {
  //   setTimeout(function() {
  //       done();
  //   }, 5000);
  // });
